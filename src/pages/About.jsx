    ...
    return (
        <>
            ...
            <section className='px-5 py-10 bg-green-900 text-white text-center'>
                ...
                <a href='tel:+15614517984' className='bg-white text-green-900 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 transition duration-300'>
                    Call Us Now: (561) 451 7984
                </a>
            </section>

            <section id='faqs' className="bg-gray-100 py-10">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="mt-10 text-center">
                        <p className="text-lg">Don’t see your question? Contact us at <span className="font-semibold">(561) 451 7984</span> for more information or to get started today.</p>
                    </div>
                </div>
            </section>
            ...
            <section className='px-5 py-10 bg-green-900 text-white text-center flex flex-col items-center'>
                ...
                <div className='bg-white rounded-xl p-10 flex items-center gap-5 mt-5 text-black text-left w-[30%]'>
                    <img src={TeamImg} alt="" className='w-36 aspect-square object-cover rounded-full' />
                    <div className='flex flex-col gap-1'>
                        <h4 className='font-bold text-2xl'>Norveline</h4>
